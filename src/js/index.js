...
function toggleTheme() {
  ...
  if (theme === "light") {
    ...
    theme = "dark";
    setLocalStorageItem("grid-notes_theme", "dark");
  } else {
    body.classList.remove("dark");
    theme = "light";
    setLocalStorageItem("grid-notes_theme", "light");
  }
...
function toggleWorkspace(workspace) {
  setLocalStorageItem("grid-notes_workspace", workspace);
  location.reload();
}
...
function onKeydown(e) {
  ...
  if (((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode >= 96 && e.keyCode <= 105)) && e.altKey && e.shiftKey) {
